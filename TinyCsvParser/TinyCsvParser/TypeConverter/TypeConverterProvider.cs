...
namespace TinyCsvParser.TypeConverter
{
  ...
  {
    private readonly IDictionary<Type, ITypeConverter> _typeConverters;
    ...
    public ITypeConverter<TTargetType> Resolve<TTargetType>()
    {
      ...
      if (!_typeConverters.TryGetValue(targetType, out typeConverter))
    ...
    {
      if (_typeConverters.ContainsKey(typeConverter.TargetType))
      ...
      _typeConverters[typeConverter.TargetType] = typeConverter;
