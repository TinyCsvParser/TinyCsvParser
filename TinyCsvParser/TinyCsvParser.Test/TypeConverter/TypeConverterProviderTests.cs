...
{
    private TypeConverterProvider provider;
    ...
    {
        NUnit.Framework.Assert.Throws<CsvTypeConverterAlreadyRegisteredException>(() => provider.Add(new Int32Converter()));
    }
    ...
    {
        NUnit.Framework.Assert.Throws<CsvTypeConverterNotRegisteredException>(() => provider.Resolve<SomeEnum>());
    }
